...
def visualize_price_control(models, before, after, lower_bound, upper_bound, 
...
visualize_price_control(models, overall_scores, price_control_scores, 1140, 1310)
...
visualize_price_control(top_models, top_overall_scores, top_price_control_scores, 1190, 1310)
# -
