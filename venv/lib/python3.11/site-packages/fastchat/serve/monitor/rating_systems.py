...
def compute_style_control(
    ...
    matchups, features, outcomes, models = preprocess_for_filter(df, apply_ratio=[1, 1, 1, 1], 
                                                                style_elements=STYLE_CONTROL_ELEMENTS_V1)
...
def compute_price_control(
    df, alpha=math.log(10.0), reg=0.5, init_rating=1000.0, scale=400.0, tol=1e-6
):
    matchups, features, outcomes, models = preprocess_for_filter(df, apply_ratio=[1], 
                                                                style_elements=PRICE_CONTROL_ELEMENTS_V1)
    ratings_params = fit_contextual_bt(
        matchups,
        features,
        outcomes,
...
def compute_bootstrap_price_control(
    df,
    num_round,
    alpha=math.log(10.0),
    reg=0.5,
